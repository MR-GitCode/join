 ...
 * @returns 
 */
function createDayGreeting(greetingText, userName) {
  return `
    <div id="greeting">
 ...
 * @returns 
 */
function createSummaryTodo(icon, number, label) {
 ...
 * @returns 
 */
function createSummaryTaskStatus(number ,date, info) {
 ...
 * @returns 
 */
function createSummaryCount(number, label) {
  return `<a href="./board.html">
            <div class="count">
              <div class="number-container">
                <div class="number">${number}</div>
 ...
 * @param {number} taskCounts Amount of taks in the category
 * @param {string} deadline Deadlin with the nearest task.
 * @returns 
 */
function createSummaryOfTasks(taskCounts, deadline) {
